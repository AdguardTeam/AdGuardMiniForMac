 ...
 */
export class MarkURLFilterInstallRequestedRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.MarkURLFilterInstallRequested'; }
