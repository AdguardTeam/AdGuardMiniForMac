...
import { EmptyValue as ReturnValue, URLFilterConfiguration as RequestMessage } from '../../types'

/**
 * Update URLFilter configuration
 */
export class UpdateURLFilterConfigurationRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.UpdateURLFilterConfiguration'; }
