...
import { EmptyValue as ReturnValue, URLFilterSeen as RequestMessage } from '../../types'

/**
 * Mark the settings UI as seen without changing the platform configuration
 */
export class MarkURLFilterSeenRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.MarkURLFilterSeen'; }
