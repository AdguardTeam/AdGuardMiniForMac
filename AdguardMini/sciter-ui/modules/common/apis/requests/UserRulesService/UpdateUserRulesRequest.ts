...
import { OptionalError as ReturnValue, UserRules as RequestMessage } from '../../types'

/**
 * Update UserRules settings
 */
export class UpdateUserRulesRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'UserRulesService.UpdateUserRules'; }
