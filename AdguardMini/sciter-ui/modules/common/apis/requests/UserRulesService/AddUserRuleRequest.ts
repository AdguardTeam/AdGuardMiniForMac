...
import { OptionalError as ReturnValue, StringValue as RequestMessage } from '../../types'

/**
 * Add UserRule
 */
export class AddUserRuleRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'UserRulesService.AddUserRule'; }
