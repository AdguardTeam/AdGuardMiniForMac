...
import { UserRules as ReturnValue, Path as RequestMessage } from '../../types'

/**
 * Import UserRules settings
 */
export class ImportUserRulesRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'UserRulesService.ImportUserRules'; }
