...
import { UserRules as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Reset UserRules to default settings
 */
export class ResetUserRulesRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'UserRulesService.ResetUserRules'; }
