...
import { OptionalError as ReturnValue, Path as RequestMessage } from '../../types'

/**
 * Export UserRules settings
 */
export class ExportUserRulesRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'UserRulesService.ExportUserRules'; }
