 ...
 */
export class RequestApplicationUpdateRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AppUpdateService.RequestApplicationUpdate'; }
