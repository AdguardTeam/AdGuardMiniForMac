...
import { EnterActivationCodeResultMessage as ReturnValue, StringValue as RequestMessage } from '../../types'

/**
 * Enter activation code
 */
export class EnterActivationCodeRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.EnterActivationCode'; }
