...
import { OptionalError as ReturnValue, SubscriptionMessage as RequestMessage } from '../../types'

/**
 * Request purchase subscription
 */
export class RequestSubscribeRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.RequestSubscribe'; }
