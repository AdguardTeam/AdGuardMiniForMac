...
import { WebActivateResultMessage as ReturnValue, StringValue as RequestMessage } from '../../types'

/**
 * Request opening bind page
 */
export class RequestBindRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.RequestBind'; }
