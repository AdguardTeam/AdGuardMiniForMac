 ...
 */
export class RequestRestorePurchasesRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.RequestRestorePurchases'; }
