 ...
 */
export class RequestOpenSubscriptionsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.RequestOpenSubscriptions'; }
