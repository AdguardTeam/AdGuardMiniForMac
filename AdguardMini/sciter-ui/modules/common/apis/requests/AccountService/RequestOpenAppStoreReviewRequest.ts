 ...
 */
export class RequestOpenAppStoreReviewRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AccountService.RequestOpenAppStoreReview'; }
