...
import { OptionalError as ReturnValue, FiltersUpdate as RequestMessage } from '../../types'

/**
 * Update filters settings
 */
export class UpdateFiltersRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.UpdateFilters'; }
