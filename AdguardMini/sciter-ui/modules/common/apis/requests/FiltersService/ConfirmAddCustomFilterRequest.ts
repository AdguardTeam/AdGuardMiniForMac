...
import { OptionalError as ReturnValue, CustomFilterToAdd as RequestMessage } from '../../types'

/**
 * Confirm add Custom filter
 */
export class ConfirmAddCustomFilterRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.ConfirmAddCustomFilter'; }
