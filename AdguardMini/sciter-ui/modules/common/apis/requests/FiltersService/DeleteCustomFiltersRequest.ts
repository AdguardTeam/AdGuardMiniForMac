...
import { OptionalError as ReturnValue, CustomFiltersToDelete as RequestMessage } from '../../types'

/**
 * Delete custom filters
 */
export class DeleteCustomFiltersRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.DeleteCustomFilters'; }
