...
import { FiltersGroupedByExtensions as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Request filters divided by safari extension
 */
export class GetFiltersGroupedByExtensionsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.GetFiltersGroupedByExtensions'; }
