 ...
 */
export class UpdateLanguageSpecificRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.UpdateLanguageSpecific'; }
