...
import { FiltersIndex as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Get filters index
 */
export class GetFiltersIndexRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.GetFiltersIndex'; }
