...
import { FilterOrError as ReturnValue, Path as RequestMessage } from '../../types'

/**
 * Check Custom Filter
 */
export class CheckCustomFilterRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'FiltersService.CheckCustomFilter'; }
