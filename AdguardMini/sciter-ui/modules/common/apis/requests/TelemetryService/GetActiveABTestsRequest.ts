...
import { ActiveABTests as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Get active AB tests
 */
export class GetActiveABTestsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'TelemetryService.GetActiveABTests'; }
