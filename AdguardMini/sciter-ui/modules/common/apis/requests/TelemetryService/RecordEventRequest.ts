...
import { EmptyValue as ReturnValue, TelemetryEvent as RequestMessage } from '../../types'

/**
 * Record telemetry event
 */
export class RecordEventRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'TelemetryService.RecordEvent'; }
