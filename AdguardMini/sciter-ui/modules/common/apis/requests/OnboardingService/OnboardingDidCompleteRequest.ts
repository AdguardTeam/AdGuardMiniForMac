 ...
 */
export class OnboardingDidCompleteRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'OnboardingService.OnboardingDidComplete'; }
