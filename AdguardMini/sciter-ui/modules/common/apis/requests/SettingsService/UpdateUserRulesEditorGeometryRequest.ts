...
import { EmptyValue as ReturnValue, WindowGeometry as RequestMessage } from '../../types'

/**
 * Update user rules editor window geometry
 */
export class UpdateUserRulesEditorGeometryRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateUserRulesEditorGeometry'; }
