...
import { EmptyValue as ReturnValue, Path as RequestMessage } from '../../types'

/**
 * Import Settings settings
 */
export class ImportSettingsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.ImportSettings'; }
