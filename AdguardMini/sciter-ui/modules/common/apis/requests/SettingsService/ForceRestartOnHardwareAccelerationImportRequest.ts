 ...
 */
export class ForceRestartOnHardwareAccelerationImportRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.ForceRestartOnHardwareAccelerationImport'; }
