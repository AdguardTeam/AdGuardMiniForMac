 ...
 */
export class UpdateHardwareAccelerationRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateHardwareAcceleration'; }
