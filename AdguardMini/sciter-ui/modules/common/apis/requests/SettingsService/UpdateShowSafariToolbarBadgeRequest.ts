 ...
 */
export class UpdateShowSafariToolbarBadgeRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateShowSafariToolbarBadge'; }
