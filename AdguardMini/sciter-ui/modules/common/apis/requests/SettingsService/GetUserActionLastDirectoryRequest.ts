 ...
 */
export class GetUserActionLastDirectoryRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.GetUserActionLastDirectory'; }
