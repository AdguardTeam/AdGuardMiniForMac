...
import { EmptyValue as ReturnValue, UpdateQuitReactionMessage as RequestMessage } from '../../types'

/**
 * Update quit reaction setting
 */
export class UpdateQuitReactionRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateQuitReaction'; }
