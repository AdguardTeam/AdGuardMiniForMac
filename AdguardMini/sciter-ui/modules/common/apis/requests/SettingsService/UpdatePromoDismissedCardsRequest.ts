 ...
 */
export class UpdatePromoDismissedCardsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdatePromoDismissedCards'; }
