...
import { Int32Value as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Get limit on the number of rules for content blockers
 */
export class GetContentBlockersRulesLimitRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.GetContentBlockersRulesLimit'; }
