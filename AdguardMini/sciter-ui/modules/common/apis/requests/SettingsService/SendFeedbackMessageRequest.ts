...
import { OptionalError as ReturnValue, SupportMessage as RequestMessage } from '../../types'

/**
 * Send message to Support
 */
export class SendFeedbackMessageRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.SendFeedbackMessage'; }
