...
import { EmptyValue as ReturnValue, ImportSettingsConfirmation as RequestMessage } from '../../types'

/**
 * Confirm Settings import with consent
 */
export class ImportSettingsConfirmRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.ImportSettingsConfirm'; }
