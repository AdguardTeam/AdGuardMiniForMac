...
import { EmptyValue as ReturnValue, UpdateThemeMessage as RequestMessage } from '../../types'

/**
 * Update theme setting
 */
export class UpdateThemeRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateTheme'; }
