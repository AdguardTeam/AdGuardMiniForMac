...
import { EmptyValue as ReturnValue, StringValue as RequestMessage } from '../../types'

/**
 * Update user action last directory
 */
export class UpdateUserActionLastDirectoryRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.UpdateUserActionLastDirectory'; }
