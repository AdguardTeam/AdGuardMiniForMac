...
public struct Settings: @unchecked Sendable {
  ...
  public var macos25OrLower: Bool {
    get {return _storage._macos25OrLower}
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 15: try { try decoder.decodeSingularBoolField(value: &_storage._mailProtectionEnabled) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._mailProtectionEnabled != false {
        try visitor.visitSingularBoolField(value: _storage._mailProtectionEnabled, fieldNumber: 15)
      }
      ...
      if _storage._non501User != false {
        try visitor.visitSingularBoolField(value: _storage._non501User, fieldNumber: 17)
      }
