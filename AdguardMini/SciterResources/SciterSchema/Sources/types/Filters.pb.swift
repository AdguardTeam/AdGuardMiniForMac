...
extension Filters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}filters\0\u{1}customFilters\0\u{1}languageSpecific\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.customFilters) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.languageSpecific) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.customFilters.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.customFilters, fieldNumber: 2)
    }
    if self.languageSpecific != false {
      try visitor.visitSingularBoolField(value: self.languageSpecific, fieldNumber: 3)
    }
