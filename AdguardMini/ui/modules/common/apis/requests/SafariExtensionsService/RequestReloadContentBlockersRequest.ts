 ...
 */
export class RequestReloadContentBlockersRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SafariExtensionsService.RequestReloadContentBlockers'; }
