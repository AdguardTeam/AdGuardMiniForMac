 ...
 */
export class UpdateMailProtectionRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.UpdateMailProtection'; }
