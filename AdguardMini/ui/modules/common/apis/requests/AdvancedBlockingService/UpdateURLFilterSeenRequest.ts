 ...
 */
export class UpdateURLFilterSeenRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.UpdateURLFilterSeen'; }
