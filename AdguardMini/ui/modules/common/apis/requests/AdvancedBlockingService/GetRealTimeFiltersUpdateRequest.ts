 ...
 */
export class GetRealTimeFiltersUpdateRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.GetRealTimeFiltersUpdate'; }
