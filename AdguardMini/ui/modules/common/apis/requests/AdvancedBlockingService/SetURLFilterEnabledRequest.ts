...
import { OptionalError as ReturnValue, BoolValue as RequestMessage } from '../../types'

/**
 * Set URLFilter enabled state
 */
export class SetURLFilterEnabledRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.SetURLFilterEnabled'; }
