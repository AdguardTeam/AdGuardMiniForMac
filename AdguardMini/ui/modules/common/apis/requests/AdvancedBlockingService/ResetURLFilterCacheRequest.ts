...
import { OptionalError as ReturnValue, EmptyValue as RequestMessage, EmptyValue as EmptyMessageImpl } from '../../types'

/**
 * Reset URLFilter prefilter cache
 */
export class ResetURLFilterCacheRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'AdvancedBlockingService.ResetURLFilterCache'; }
