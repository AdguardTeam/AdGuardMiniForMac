 ...
 */
export class OpenDiagnosticsWindowRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'InternalService.OpenDiagnosticsWindow'; }
