 ...
 */
export class GetPromoDismissedCardsRequest extends PlatformRequest<ReturnValue, RequestMessage> {
    /**
     ...
     */
    public get FQN() { return 'SettingsService.GetPromoDismissedCards'; }
