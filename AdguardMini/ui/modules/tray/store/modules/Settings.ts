...
export class SettingsStore {
    ...
    /**
     * Whether the tray window is currently visible.
     * Updated via the platform's `OnTrayWindowVisibilityChange` callback.
     */
    public trayWindowVisible = false;

    /**
     * Effective theme of the tray window.
     */
    ...
    /**
     * Set tray window visibility
     * @param visible Whether the tray window is visible
     */
    public setTrayWindowVisible(visible: boolean) {
        this.trayWindowVisible = visible;
    }
