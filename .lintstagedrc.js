module.exports = {
    ...
    "AdguardMini/sciter-ui/modules/common/stores/NotificationsQueue.ts": () => "yarn test:node",
    "AdguardMini/sciter-ui/modules/common/utils/NotificationPropsHolder.ts": () => "yarn test:node",
