...
* Stop trackers and analytics beacons to protect your privacy
* Eliminate annoyances: cookie notices, social widgets, assistant windows and sticky bars
* Control everything from the Safari toolbar
* Select and block manually any element on a page 
